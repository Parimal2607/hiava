                  ...
                  <CardBody>
                    <div className="d-flex gap-1">
                      ...
                      <div className="card-content">
                        ...
                        <p>
                          Trained on industry best practices and proven
                          examples, enabling it to generate high-quality writing
                          for 50+ unique use-cases.
                        </p>
                      </div>
                    </div>
                  </CardBody>
                  ...
                  <CardBody>
                    <div className="d-flex gap-1">
                      ...
                      <div className="card-content">
                        <h5>Chat with Ava</h5>
                        <p>
                          Ask your friendly AI assistant to generate ideas,
                          revise your content, and even make you laugh.
                        </p>
                      </div>
                    </div>
                  </CardBody>
              ...
              <Card className="dashboard-welcome-cards tem-card h-100">
                <CardBody className="align-items-baseline card-body h-100 d-flex flex-column justify-content-between">
                  ...
                  <div className="card-content">
                    ...
                    <p>
                      Generate high-quality content outline for a blog post.
                    </p>
                  </div>
                </CardBody>
              </Card>
              ...
              <Card className="ava-use-cards">
                <CardBody className="p-0">
                  ...
                  <div className="ava-content">
                    ...
                    <p>
                      Say Hell to Ava chat: Your helpful AI writing assistant
                      that helps you write your first draft in seconds.
                    </p>
                  </div>
                </CardBody>
              </Card>
