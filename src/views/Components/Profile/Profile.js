...
import CuAvatar from "../../../assets/images/portrait/small/avatar-s-11.jpg"
...
const Profile = ({ data }) => {
  ...
  // ** States
  const [avatar, setAvatar] = useState(CuAvatar)
          ...
          <Form className='mt-2 pt-50' onSubmit={handleSubmit(onSubmit)}>
            <Row>
              ...
              <Col sm='6' className='mb-1'>
                ...
                <Input id='emailInput' type='email' name='email' placeholder='Email' defaultValue="sumit123@gmail.com" />
              </Col>
              <Col sm='6' className='mb-1'>
                <Label className='form-label' for='company'>
                  Company
                </Label>
                <Input defaultValue="zignuts" id='company' name='company' placeholder='Company Name' />
              </Col>
              <Col sm='6' className='mb-1'>
